<?php
    ...
    $name = "Trung Cao";
    $info = "Junior, Computer Science & Applied Software Engineering";
?>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-sm-8 col-lg-6">
                ...
                <div class="section_heading text-center wow fadeInUp" data-wow-delay="0.2s"
                    ...
                    <?php
                        echo "<h3>$classTitle</h3>";
                        echo "<p>$classDescription</p>";
                    ?>
                    <div class="line"></div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.2s"
                    style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                    <!-- Team Thumb-->
                    <div class="advisor_thumb"><a href="Trung_Cao.php"><img
                                src="./assets/images/IMG_0675.jpg" alt="" style="width: 315px"></a>
                        <!-- Social Info-->
                        <div class="social-info"><a href="Trung_Cao.php"><i class="fa fa-facebook"></i></a><a
                                href="Trung_Cao.php"><i class="fa fa-twitter"></i></a><a href="Trung_Cao.php"><i
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.3s"
                    ...
                    <!-- Team Thumb-->
                    <div class="advisor_thumb"><a href="detail.html"><img
